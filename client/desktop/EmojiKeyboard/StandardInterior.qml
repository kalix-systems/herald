...
ListView {
    ...
    delegate: Column {
        ...
        GridView {
            id: rep
            interactive: false
            model: emoji_boundaries[index + 1] - emoji_boundaries[index]
            width: parent.width
            ...
            delegate: EmojiButton {
                baseEmoji: emojiPickerModel.emoji(rep.base + index)
                takesModifier: emojiPickerModel.skintone_modifier(
                                   rep.base + index)
            }
        }
    }
