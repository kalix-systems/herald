...
impl ContactsEmitter {
    ...
    fn clear(&self) {
        ...
        self.qobject
            .store(n as *mut ContactsQObject, Ordering::SeqCst);
    }
...
#[no_mangle]
pub unsafe extern "C" fn contacts_add(
    ptr: *mut Contacts,
...
#[no_mangle]
pub unsafe extern "C" fn contacts_insert_rows(
    ptr: *mut Contacts,
    row: c_int,
    count: c_int,
) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn contacts_remove_rows(
    ptr: *mut Contacts,
    row: c_int,
    count: c_int,
) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn contacts_sort(ptr: *mut Contacts, column: u8, order: SortOrder) {
...
#[no_mangle]
pub unsafe extern "C" fn contacts_set_data_color(ptr: *mut Contacts, row: c_int, v: u32) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn contacts_set_data_profile_picture_none(
    ptr: *mut Contacts,
    row: c_int,
) -> bool {
...
pub unsafe extern "C" fn messages_delete_conversation_by_id(
    ptr: *mut Messages,
    conversation_id_str: *const c_ushort,
...
pub unsafe extern "C" fn messages_insert_message(
    ...
    let o = &mut *ptr;
    let r = o.insert_message(body, send_status);
    r
}
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_send_status(ptr: *const Messages, row: c_int) -> u32 {
    let o = &*ptr;
    o.send_status(to_usize(row)).into()
}
