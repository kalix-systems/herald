...
#[no_mangle]
pub unsafe extern "C" fn conversation_builder_finalize(
    ptr: *mut ConversationBuilder,
    d: *mut QByteArray,
...
#[no_mangle]
pub unsafe extern "C" fn members_set_data_color(ptr: *mut Members, row: c_int, v: u32) -> bool {
    (&mut *ptr).set_color(to_usize(row), v)
}
...
#[no_mangle]
pub unsafe extern "C" fn members_set_data_profile_picture_none(
    ptr: *mut Members,
    row: c_int,
) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn members_set_data_status(ptr: *mut Members, row: c_int, v: u8) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn messages_send_message(
    ptr: *mut Messages,
    body_str: *const c_ushort,
    body_len: c_int,
) -> bool {
