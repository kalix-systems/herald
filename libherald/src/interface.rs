...
#[no_mangle]
pub unsafe extern "C" fn conversations_handle_contact_req_ack(
    ptr: *mut Conversations,
    notif_str: *const c_char,
    notif_len: c_int,
) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn conversations_refresh(
    ptr: *mut Conversations,
    notif_conv_id_str: *const c_char,
    notif_conv_id_len: c_int,
) -> bool {
    let notif_conv_id =
        { slice::from_raw_parts(notif_conv_id_str as *const u8, to_usize(notif_conv_id_len)) };
    let o = &mut *ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_message_body_by_id(
    ptr: *const Messages,
...
#[no_mangle]
pub unsafe extern "C" fn network_handle_next_add_contact_resp(
...
#[no_mangle]
pub unsafe extern "C" fn network_handle_next_add_conversation_resp(
    ptr: *mut NetworkHandle,
    d: *mut QByteArray,
    set: fn(*mut QByteArray, str: *const c_char, len: c_int),
) {
...
#[no_mangle]
pub unsafe extern "C" fn network_handle_next_new_contact(
    ptr: *mut NetworkHandle,
    d: *mut QString,
    set: fn(*mut QString, str: *const c_char, len: c_int),
) {
...
#[no_mangle]
pub unsafe extern "C" fn network_handle_next_new_conversation(
    ptr: *mut NetworkHandle,
    d: *mut QByteArray,
    set: fn(*mut QByteArray, str: *const c_char, len: c_int),
) {
...
#[no_mangle]
pub unsafe extern "C" fn network_handle_register_new_user(
    ptr: *mut NetworkHandle,
...
#[no_mangle]
pub unsafe extern "C" fn users_add_to_conversation_by_id(
    ptr: *mut Users,
    user_id_str: *const c_ushort,
    user_id_len: c_int,
    conversation_id_str: *const c_char,
...
#[no_mangle]
pub unsafe extern "C" fn users_refresh(
    ptr: *mut Users,
    notif_user_id_str: *const c_ushort,
    notif_user_id_len: c_int,
) -> bool {
