...
#[no_mangle]
pub unsafe extern "C" fn users_add_to_conversation(ptr: *mut Users, row_index: u64, conversation_id_str: *const c_char, conversation_id_len: c_int) -> bool {
    let conversation_id = { slice::from_raw_parts(conversation_id_str as *const u8, to_usize(conversation_id_len)) };
    let o = &mut *ptr;
...
#[no_mangle]
pub unsafe extern "C" fn users_refresh(ptr: *mut Users) -> () {
    let o = &mut *ptr;
    let r = o.refresh();
    r
}
