...
#[no_mangle]
pub unsafe extern "C" fn conversation_builder_picture_set(ptr: *mut ConversationBuilder, v: *const c_ushort, len: c_int) {
    let o = &mut *ptr;
    let mut s = String::new();
    set_string_from_utf16(&mut s, v, len);
...
impl GlobalMessageSearchEmitter {
    ...
    fn clear(&self) {
        ...
        self.qobject.store(n as *mut GlobalMessageSearchQObject, Ordering::SeqCst);
    }
...
#[no_mangle]
pub unsafe extern "C" fn global_message_search_regex_search_get(ptr: *const GlobalMessageSearch) -> COption<bool> {
...
#[no_mangle]
pub unsafe extern "C" fn global_message_search_regex_search_set(ptr: *mut GlobalMessageSearch, v: bool) {
    (&mut *ptr).set_regex_search(Some(v));
}

#[no_mangle]
pub unsafe extern "C" fn global_message_search_regex_search_set_none(ptr: *mut GlobalMessageSearch) {
    let o = &mut *ptr;
...
#[no_mangle]
pub unsafe extern "C" fn global_message_search_search_pattern_set(ptr: *mut GlobalMessageSearch, v: *const c_ushort, len: c_int) {
    let o = &mut *ptr;
    let mut s = String::new();
    set_string_from_utf16(&mut s, v, len);
...
#[no_mangle]
pub unsafe extern "C" fn global_message_search_search_pattern_set_none(ptr: *mut GlobalMessageSearch) {
    let o = &mut *ptr;
...
#[no_mangle]
pub unsafe extern "C" fn global_message_search_insert_rows(ptr: *mut GlobalMessageSearch, row: c_int, count: c_int) -> bool {
    match (to_usize(row), to_usize(count)) {
        (Some(row), Some(count)) => {
            (&mut *ptr).insert_rows(row, count)
        }
...
#[no_mangle]
pub unsafe extern "C" fn global_message_search_remove_rows(ptr: *mut GlobalMessageSearch, row: c_int, count: c_int) -> bool {
    match (to_usize(row), to_usize(count)) {
        (Some(row), Some(count)) => {
            (&mut *ptr).remove_rows(row, count)
        }
...
#[no_mangle]
pub unsafe extern "C" fn global_message_search_can_fetch_more(ptr: *const GlobalMessageSearch) -> bool {
    (&*ptr).can_fetch_more()
}
...
pub unsafe extern "C" fn global_message_search_data_author(
    ptr: *const GlobalMessageSearch, row: c_int,
    d: *mut QString,
    set: fn(*mut QString, *const c_char, len: c_int),
) {
    let o = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn global_message_search_data_has_attachments(ptr: *const GlobalMessageSearch, row: c_int) -> COption<bool> {
    let o = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn global_message_search_data_time(ptr: *const GlobalMessageSearch, row: c_int) -> COption<i64> {
    let o = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn herald_state_register_new_user(ptr: *mut HeraldState, user_id_str: *const c_ushort, user_id_len: c_int) {
    let mut user_id = String::new();
    set_string_from_utf16(&mut user_id, user_id_str, user_id_len);
    let o = &mut *ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_search_pattern_set(ptr: *mut Messages, v: *const c_ushort, len: c_int) {
    let o = &mut *ptr;
    let mut s = String::new();
    set_string_from_utf16(&mut s, v, len);
...
#[no_mangle]
pub unsafe extern "C" fn users_search_filter_set(ptr: *mut UsersSearch, v: *const c_ushort, len: c_int) {
    let o = &mut *ptr;
    let mut s = String::new();
    set_string_from_utf16(&mut s, v, len);
    o.set_filter(Some(s));
...
pub unsafe extern "C" fn users_search_data_name(
    ptr: *const UsersSearch, row: c_int,
    d: *mut QString,
    set: fn(*mut QString, *const c_char, len: c_int),
) {
    let o = &*ptr;
