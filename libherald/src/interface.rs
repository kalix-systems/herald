...
impl ConversationEmitter {
    ...
    fn clear(&self) {
        ...
        self.qobject
            .store(n as *mut ConversationQObject, Ordering::SeqCst);
    }
    pub fn color_changed(&mut self) {
        let ptr = self.qobject.load(Ordering::SeqCst);
        if !ptr.is_null() {
...
#[no_mangle]
pub unsafe extern "C" fn conversation_conversation_id_set(
...
#[no_mangle]
pub unsafe extern "C" fn conversation_picture_set(
    ptr: *mut Conversation,
    v: *const c_ushort,
    len: c_int,
) {
...
#[no_mangle]
pub unsafe extern "C" fn conversation_title_set(
    ptr: *mut Conversation,
    v: *const c_ushort,
    len: c_int,
) {
...
#[no_mangle]
pub unsafe extern "C" fn conversation_delete_conversation_by_id(
    ptr: *mut Conversation,
...
#[no_mangle]
pub unsafe extern "C" fn conversation_delete_message(
    ptr: *mut Conversation,
    row_index: u64,
) -> bool {
    let o = &mut *ptr;
...
#[no_mangle]
pub unsafe extern "C" fn conversation_insert_message(
    ptr: *mut Conversation,
...
#[no_mangle]
pub unsafe extern "C" fn conversation_reply(
    ptr: *mut Conversation,
    body_str: *const c_ushort,
    body_len: c_int,
    op_str: *const c_char,
...
#[no_mangle]
pub unsafe extern "C" fn conversation_insert_rows(
    ptr: *mut Conversation,
    row: c_int,
    count: c_int,
) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn conversation_remove_rows(
    ptr: *mut Conversation,
    row: c_int,
    count: c_int,
) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn conversation_sort(ptr: *mut Conversation, column: u8, order: SortOrder) {
...
#[no_mangle]
pub unsafe extern "C" fn conversation_data_epoch_timestamp_ms(
    ptr: *const Conversation,
    row: c_int,
) -> i64 {
    let o = &*ptr;
