...
impl MessageBuilderEmitter {
    ...
    pub fn op_doc_attachments_changed(&mut self) {
        let ptr = self.qobject.load(Ordering::SeqCst);
    ...
    pub fn op_media_attachments_changed(&mut self) {
        let ptr = self.qobject.load(Ordering::SeqCst);

        if !ptr.is_null() {
            (self.op_media_attachments_changed)(ptr);
        }
    }
...
pub trait MessageBuilderTrait {
    fn new(emit: MessageBuilderEmitter, model: MessageBuilderList, document_attachments: DocumentAttachments, media_attachments: MediaAttachments) -> Self;
    ...
    fn set_op_id(&mut self, value: Option<&[u8]>);
    ...
    fn remove_doc(&mut self, row_index: u64) -> bool;

    fn remove_media(&mut self, row_index: u64) -> bool;
...
#[no_mangle]
pub unsafe extern "C" fn message_builder_new(ptr_bundle: *mut MessageBuilderPtrBundle) -> *mut MessageBuilder {
    let d_message_builder = message_builder_new_inner(ptr_bundle);
    Box::into_raw(Box::new(d_message_builder))
}

pub unsafe fn message_builder_new_inner(ptr_bundle: *mut MessageBuilderPtrBundle) -> MessageBuilder {
...
#[no_mangle]
pub unsafe extern "C" fn message_builder_remove_doc(ptr: *mut MessageBuilder, row_index: u64) -> bool {
    let obj = &mut *ptr;
    obj.remove_doc(
    row_index,
    )
...
#[no_mangle]
pub unsafe extern "C" fn message_builder_remove_media(ptr: *mut MessageBuilder, row_index: u64) -> bool {
    let obj = &mut *ptr;
    obj.remove_media(
    row_index,
    )
...
#[no_mangle]
pub unsafe extern "C" fn message_builder_body_get(ptr: *const MessageBuilder, prop: *mut QString, set: fn(*mut QString, *const c_char, c_int)) {
    let obj = &*ptr;
    let value = obj.body();
...
#[no_mangle]
pub unsafe extern "C" fn message_builder_body_set(ptr: *mut MessageBuilder, value: *const c_ushort, len: c_int) {
    let obj = &mut *ptr;
...
#[no_mangle]
pub unsafe extern "C" fn message_builder_document_attachments_get(ptr: *mut MessageBuilder) -> *mut DocumentAttachments {
    (&mut *ptr).document_attachments_mut()
}

#[no_mangle]
pub unsafe extern "C" fn message_builder_has_doc_attachment_get(ptr: *const MessageBuilder) -> bool {
    (&*ptr).has_doc_attachment()
}

#[no_mangle]
pub unsafe extern "C" fn message_builder_has_media_attachment_get(ptr: *const MessageBuilder) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn message_builder_media_attachments_get(ptr: *mut MessageBuilder) -> *mut MediaAttachments {
    (&mut *ptr).media_attachments_mut()
}

#[no_mangle]
pub unsafe extern "C" fn message_builder_op_author_get(ptr: *const MessageBuilder, prop: *mut QString, set: fn(*mut QString, *const c_char, c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn message_builder_op_body_get(ptr: *const MessageBuilder, prop: *mut QString, set: fn(*mut QString, *const c_char, c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn message_builder_op_doc_attachments_get(ptr: *const MessageBuilder, prop: *mut QString, set: fn(*mut QString, *const c_char, c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn message_builder_op_expiration_time_get(ptr: *const MessageBuilder) -> COption<i64> {
...
#[no_mangle]
pub unsafe extern "C" fn message_builder_op_id_get(ptr: *const MessageBuilder, prop: *mut QByteArray, set: fn(*mut QByteArray, *const c_char, c_int)) {
    let obj = &*ptr;
    let value = obj.op_id();
    if let Some(value) = value {
        let str_: *const c_char = value.as_ptr() as (*const c_char);
...
#[no_mangle]
pub unsafe extern "C" fn message_builder_op_id_set(ptr: *mut MessageBuilder, value: *const c_char, len: c_int) {
    let obj = &mut *ptr;
...
#[no_mangle]
pub unsafe extern "C" fn message_builder_op_media_attachments_get(ptr: *const MessageBuilder, prop: *mut QString, set: fn(*mut QString, *const c_char, c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn message_builder_sort(ptr: *mut MessageBuilder, column: u8, order: SortOrder) {
