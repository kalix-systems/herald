...
pub trait MessagesTrait {
    ...
    fn author_color(&self, index: usize) -> Option<u32>;

    fn author_name(&self, index: usize) -> Option<String>;

    fn author_profile_picture(&self, index: usize) -> String;
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_author_color(ptr: *const Messages, row: c_int) -> COption<u32> {
    let obj = &*ptr;
    obj.author_color(to_usize(row).unwrap_or(0)).into()
}

#[no_mangle]
pub unsafe extern "C" fn messages_data_author_name(ptr: *const Messages, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_author_profile_picture(ptr: *const Messages, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
