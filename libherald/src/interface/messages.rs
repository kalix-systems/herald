...
pub trait MessagesTrait {
    fn new(emit: MessagesEmitter, model: MessagesList, builder: MessageBuilder) -> Self;
    ...
    fn save_all_attachments(&self, index: u64, dest: String) -> bool;

    fn set_elision_char_count(&mut self, char_count: u16) -> ();

    fn set_elision_chars_per_line(&mut self, chars_per_line: u8) -> ();

    fn set_elision_line_count(&mut self, line_count: u8) -> ();
    ...
    fn author(&self, index: usize) -> Option<String>;

    fn body(&self, index: usize) -> Option<String>;

    fn doc_attachments(&self, index: usize) -> String;

    fn expiration_time(&self, index: usize) -> Option<i64>;

    fn full_body(&self, index: usize) -> Option<String>;

    fn insertion_time(&self, index: usize) -> Option<i64>;
    ...
    fn media_attachments(&self, index: usize) -> String;

    fn msg_id(&self, index: usize) -> Option<&[u8]>;

    fn op_author(&self, index: usize) -> Option<String>;

    fn op_body(&self, index: usize) -> Option<String>;

    fn op_color(&self, index: usize) -> Option<u32>;

    fn op_doc_attachments(&self, index: usize) -> String;

    fn op_expiration_time(&self, index: usize) -> Option<i64>;

    fn op_insertion_time(&self, index: usize) -> Option<i64>;

    fn op_media_attachments(&self, index: usize) -> String;

    fn op_msg_id(&self, index: usize) -> Option<Vec<u8>>;

    fn op_name(&self, index: usize) -> Option<String>;

    fn receipt_status(&self, index: usize) -> Option<u32>;

    fn reply_type(&self, index: usize) -> Option<u8>;

    fn server_time(&self, index: usize) -> Option<i64>;

    fn user_color(&self, index: usize) -> Option<u32>;

    fn user_name(&self, index: usize) -> Option<String>;

    fn user_profile_picture(&self, index: usize) -> Option<String>;
}
...
#[no_mangle]
pub unsafe extern "C" fn messages_save_all_attachments(ptr: *const Messages, index: u64, dest_str: *const c_ushort, dest_len: c_int) -> bool {
    let obj = &*ptr;
    let mut dest = String::new();
    set_string_from_utf16(&mut dest, dest_str, dest_len);
    obj.save_all_attachments(
    index,
    dest,
    )
}
...
#[no_mangle]
pub unsafe extern "C" fn messages_set_elision_char_count(ptr: *mut Messages, char_count: u16) {
    let obj = &mut *ptr;
    obj.set_elision_char_count(
    char_count,
    )
}

#[no_mangle]
pub unsafe extern "C" fn messages_set_elision_chars_per_line(ptr: *mut Messages, chars_per_line: u8) {
    let obj = &mut *ptr;
    obj.set_elision_chars_per_line(
    chars_per_line,
    )
}

#[no_mangle]
pub unsafe extern "C" fn messages_set_elision_line_count(ptr: *mut Messages, line_count: u8) {
    let obj = &mut *ptr;
    obj.set_elision_line_count(
    line_count,
    )
}

#[no_mangle]
pub unsafe extern "C" fn messages_set_search_hint(ptr: *mut Messages, scrollbar_position: f32, scrollbar_height: f32) {
    let obj = &mut *ptr;
    obj.set_search_hint(
    scrollbar_position,
    scrollbar_height,
...
#[no_mangle]
pub unsafe extern "C" fn messages_last_author_get(ptr: *const Messages, prop: *mut QString, set: fn(*mut QString, *const c_char, c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_last_body_get(ptr: *const Messages, prop: *mut QString, set: fn(*mut QString, *const c_char, c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_search_active_set(ptr: *mut Messages, value: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn messages_search_pattern_get(ptr: *const Messages, prop: *mut QString, set: fn(*mut QString, *const c_char, c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_search_pattern_set(ptr: *mut Messages, value: *const c_ushort, len: c_int) {
    let obj = &mut *ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_search_regex_set(ptr: *mut Messages, value: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_author(ptr: *const Messages, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_body(ptr: *const Messages, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_doc_attachments(ptr: *const Messages, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_expiration_time(ptr: *const Messages, row: c_int) -> COption<i64> {
    let obj = &*ptr;
    obj.expiration_time(to_usize(row).unwrap_or(0)).into()
}

#[no_mangle]
pub unsafe extern "C" fn messages_data_full_body(ptr: *const Messages, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_insertion_time(ptr: *const Messages, row: c_int) -> COption<i64> {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_match_status(ptr: *const Messages, row: c_int) -> COption<u8> {
    let obj = &*ptr;
    obj.match_status(to_usize(row).unwrap_or(0)).into()
}

#[no_mangle]
pub unsafe extern "C" fn messages_data_media_attachments(ptr: *const Messages, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_msg_id(ptr: *const Messages, row: c_int, d: *mut QByteArray, set: fn(*mut QByteArray, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_op_author(ptr: *const Messages, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_op_body(ptr: *const Messages, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_op_color(ptr: *const Messages, row: c_int) -> COption<u32> {
    let obj = &*ptr;
    obj.op_color(to_usize(row).unwrap_or(0)).into()
}

#[no_mangle]
pub unsafe extern "C" fn messages_data_op_doc_attachments(ptr: *const Messages, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_op_expiration_time(ptr: *const Messages, row: c_int) -> COption<i64> {
    let obj = &*ptr;
    obj.op_expiration_time(to_usize(row).unwrap_or(0)).into()
}

#[no_mangle]
pub unsafe extern "C" fn messages_data_op_insertion_time(ptr: *const Messages, row: c_int) -> COption<i64> {
    let obj = &*ptr;
    obj.op_insertion_time(to_usize(row).unwrap_or(0)).into()
}

#[no_mangle]
pub unsafe extern "C" fn messages_data_op_media_attachments(ptr: *const Messages, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_op_msg_id(ptr: *const Messages, row: c_int, d: *mut QByteArray, set: fn(*mut QByteArray, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_op_name(ptr: *const Messages, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_reply_type(ptr: *const Messages, row: c_int) -> COption<u8> {
    let obj = &*ptr;
    obj.reply_type(to_usize(row).unwrap_or(0)).into()
}

#[no_mangle]
pub unsafe extern "C" fn messages_data_server_time(ptr: *const Messages, row: c_int) -> COption<i64> {
    let obj = &*ptr;
    obj.server_time(to_usize(row).unwrap_or(0)).into()
}

#[no_mangle]
pub unsafe extern "C" fn messages_data_user_color(ptr: *const Messages, row: c_int) -> COption<u32> {
    let obj = &*ptr;
    obj.user_color(to_usize(row).unwrap_or(0)).into()
}

#[no_mangle]
pub unsafe extern "C" fn messages_data_user_name(ptr: *const Messages, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
    let data = obj.user_name(to_usize(row).unwrap_or(0));
    if let Some(data) = data {
        let str_: *const c_char = data.as_ptr() as (*const c_char);
        set(d, str_, to_c_int(data.len()));
    }
...
#[no_mangle]
pub unsafe extern "C" fn messages_data_user_profile_picture(ptr: *const Messages, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
    let data = obj.user_profile_picture(to_usize(row).unwrap_or(0));
    if let Some(data) = data {
        let str_: *const c_char = data.as_ptr() as (*const c_char);
        set(d, str_, to_c_int(data.len()));
    }
