...
pub trait ConversationBuilderTrait {
    ...
    fn member_name(&self, index: usize) -> String;

    fn member_profile_picture(&self, index: usize) -> String;
}
...
#[no_mangle]
pub unsafe extern "C" fn conversation_builder_data_member_name(ptr: *const ConversationBuilder, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn conversation_builder_data_member_profile_picture(ptr: *const ConversationBuilder, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
