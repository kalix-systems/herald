...
#[no_mangle]
pub unsafe extern "C" fn conversation_builder_new(
    ptr_bundle: *mut ConversationBuilderPtrBundle
...
pub unsafe fn conversation_builder_new_inner(
    ptr_bundle: *mut ConversationBuilderPtrBundle
) -> ConversationBuilder {
...
pub unsafe extern "C" fn conversation_builder_remove_member_by_id(
    ...
    let mut user_id = String::new();
    set_string_from_utf16(&mut user_id, user_id_str, user_id_len);
    obj.remove_member_by_id(user_id)
}
...
pub unsafe extern "C" fn conversation_builder_remove_member_by_index(
    ...
    let obj = &mut *ptr;
    obj.remove_member_by_index(index)
}
