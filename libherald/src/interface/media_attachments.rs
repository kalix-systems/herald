...
impl MediaAttachmentsEmitter {
    ...
    pub fn clear(&self) {
        ...
        self.qobject.store(n as *mut MediaAttachmentsQObject, Ordering::SeqCst);
    }
...
pub trait MediaAttachmentsTrait {
    fn new(emit: MediaAttachmentsEmitter, model: MediaAttachmentsList) -> Self;
    ...
    fn media_attachment_path(&self, index: usize) -> &str;
}

#[no_mangle]
pub unsafe extern "C" fn media_attachments_new(ptr_bundle: *mut MediaAttachmentsPtrBundle) -> *mut MediaAttachments {
    let d_media_attachments = media_attachments_new_inner(ptr_bundle);
    Box::into_raw(Box::new(d_media_attachments))
}

pub unsafe fn media_attachments_new_inner(ptr_bundle: *mut MediaAttachmentsPtrBundle) -> MediaAttachments {
...
#[no_mangle]
pub unsafe extern "C" fn media_attachments_media_attachment_four_get(ptr: *const MediaAttachments, prop: *mut QString, set: fn(*mut QString, *const c_char, c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn media_attachments_media_attachment_one_get(ptr: *const MediaAttachments, prop: *mut QString, set: fn(*mut QString, *const c_char, c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn media_attachments_media_attachment_three_get(ptr: *const MediaAttachments, prop: *mut QString, set: fn(*mut QString, *const c_char, c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn media_attachments_media_attachment_two_get(ptr: *const MediaAttachments, prop: *mut QString, set: fn(*mut QString, *const c_char, c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn media_attachments_insert_rows(ptr: *mut MediaAttachments, row: c_int, count: c_int) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn media_attachments_remove_rows(ptr: *mut MediaAttachments, row: c_int, count: c_int) -> bool {
    match (to_usize(row), to_usize(count)) {
        (Some(row), Some(count)) => 
        {
...
#[no_mangle]
pub unsafe extern "C" fn media_attachments_sort(ptr: *mut MediaAttachments, column: u8, order: SortOrder) {
    (&mut *ptr).sort(column, order)
}

#[no_mangle]
pub unsafe extern "C" fn media_attachments_data_media_attachment_path(ptr: *const MediaAttachments, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
