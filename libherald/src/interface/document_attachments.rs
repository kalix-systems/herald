...
pub trait DocumentAttachmentsTrait {
    ...
    fn document_attachment_path(&self, index: usize) -> &str;
...
#[no_mangle]
pub unsafe extern "C" fn document_attachments_data_document_attachment_path(ptr: *const DocumentAttachments, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
