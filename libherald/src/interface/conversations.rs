...
pub trait ConversationsTrait {
    ...
    fn index_by_id(&self, conversation_id: &[u8]) -> i64;
...
#[no_mangle]
pub unsafe extern "C" fn conversations_new(ptr_bundle: *mut ConversationsPtrBundle) -> *mut Conversations {
...
#[no_mangle]
pub unsafe extern "C" fn conversations_index_by_id(ptr: *const Conversations, conversation_id_str: *const c_char, conversation_id_len: c_int) -> i64 {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn conversations_filter_get(ptr: *const Conversations, prop: *mut QString, set: fn(*mut QString, *const c_char, c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn conversations_filter_set(ptr: *mut Conversations, value: *const c_ushort, len: c_int) {
    let obj = &mut *ptr;
...
#[no_mangle]
pub unsafe extern "C" fn conversations_filter_regex_set(ptr: *mut Conversations, value: bool) {
...
#[no_mangle]
pub unsafe extern "C" fn conversations_set_data_color(ptr: *mut Conversations, row: c_int, value: u32) -> bool {
    (&mut *ptr).set_color(to_usize(row).unwrap_or(0), value)
}

#[no_mangle]
pub unsafe extern "C" fn conversations_data_conversation_id(ptr: *const Conversations, row: c_int, d: *mut QByteArray, set: fn(*mut QByteArray, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn conversations_set_data_expiration_period(ptr: *mut Conversations, row: c_int, value: u8) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn conversations_set_data_muted(ptr: *mut Conversations, row: c_int, value: bool) -> bool {
...
#[no_mangle]
pub unsafe extern "C" fn conversations_data_picture(ptr: *const Conversations, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn conversations_set_data_picture(ptr: *mut Conversations, row: c_int, str_: *const c_ushort, len: c_int) -> bool {
    let obj = &mut *ptr;
...
#[no_mangle]
pub unsafe extern "C" fn conversations_data_title(ptr: *const Conversations, row: c_int, d: *mut QString, set: fn(*mut QString, *const c_char, len: c_int)) {
    let obj = &*ptr;
...
#[no_mangle]
pub unsafe extern "C" fn conversations_set_data_title(ptr: *mut Conversations, row: c_int, str_: *const c_ushort, len: c_int) -> bool {
    let obj = &mut *ptr;
    let mut value = String::new();
    set_string_from_utf16(&mut value, str_, len);
