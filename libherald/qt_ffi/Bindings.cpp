...
void conversation_builder_data_member_name(const ConversationBuilder::Private*, int, QString*, qstring_set);
...
void messages_data_author_name(const Messages::Private*, int, QString*, qstring_set);
void messages_data_author_profile_picture(const Messages::Private*, int, QString*, qstring_set);
