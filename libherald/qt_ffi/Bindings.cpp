...
MessagesRef conversations_data_messages(const Conversations::Private*, int);
...
MessagesRef Conversations::messages(int row) const
{
  return conversations_data_messages(m_d, row);
}
...
QHash<int, QByteArray> Conversations::roleNames() const
{
  ...
  names.insert(Qt::UserRole + 4, "messages");
  names.insert(Qt::UserRole + 5, "muted");
  names.insert(Qt::UserRole + 6, "pairwise");
  names.insert(Qt::UserRole + 7, "picture");
...
bool message_builder_remove_attachment(MessageBuilder::Private*, const ushort*,
                                       int);
...
QModelIndex Messages::parent(const QModelIndex&) const { return QModelIndex(); }
...
Conversations::Conversations(QObject* parent)
    : QAbstractItemModel(parent),
      m_d(conversations_new(new ConversationsPtrBundle{
          ...
          [](Conversations* o) {
            return new MessagesPtrBundle{
                new Messages(o),
                new MessageBuilder(o),
                [](MessageBuilder* o) { Q_EMIT o->bodyChanged(); },
                [](MessageBuilder* o) { Q_EMIT o->isMediaMessageChanged(); },
                [](MessageBuilder* o) { Q_EMIT o->isReplyChanged(); },
                [](MessageBuilder* o) { Q_EMIT o->opAuthorChanged(); },
                [](MessageBuilder* o) { Q_EMIT o->opBodyChanged(); },
                [](MessageBuilder* o) { Q_EMIT o->opHasAttachmentsChanged(); },
                [](MessageBuilder* o) { Q_EMIT o->opIdChanged(); },
                [](MessageBuilder* o) { Q_EMIT o->opTimeChanged(); },
                [](MessageBuilder* o) { Q_EMIT o->parseMarkdownChanged(); },
                ...
                [](Messages* o) { Q_EMIT o->builderOpMsgIdChanged(); },
                [](Messages* o) { Q_EMIT o->conversationIdChanged(); },
                [](Messages* o) { Q_EMIT o->isEmptyChanged(); },
                [](Messages* o) { Q_EMIT o->lastAuthorChanged(); },
                [](Messages* o) { Q_EMIT o->lastBodyChanged(); },
                [](Messages* o) { Q_EMIT o->lastStatusChanged(); },
                [](Messages* o) { Q_EMIT o->lastTimeChanged(); },
                [](Messages* o) { Q_EMIT o->searchActiveChanged(); },
                [](Messages* o) { Q_EMIT o->searchIndexChanged(); },
                [](Messages* o) { Q_EMIT o->searchNumMatchesChanged(); },
                [](Messages* o) { Q_EMIT o->searchPatternChanged(); },
                [](Messages* o) { Q_EMIT o->searchRegexChanged(); },
                [](const Messages* o) {
                  Q_EMIT o->newDataReady(QModelIndex());
                },
