...
extern "C" {Config::Private* config_new(ConfigPtrBundle*);
...
Qt::ItemFlags ConversationBuilder::flags(const QModelIndex &i) const { auto flags = QAbstractItemModel::flags(i);
 return flags;
}
...
extern "C" {ConversationBuilder::Private* conversation_builder_new(ConversationBuilderPtrBundle*);
...
bool
conversation_builder_add_member(ConversationBuilder::Private*
,const ushort*, int
);
void
conversation_builder_clear(ConversationBuilder::Private*
);
void
conversation_builder_finalize(ConversationBuilder::Private*
);
void
conversation_builder_remove_last(ConversationBuilder::Private*
);
bool
conversation_builder_remove_member_by_id(ConversationBuilder::Private*
,const ushort*, int
);
bool
conversation_builder_remove_member_by_index(ConversationBuilder::Private*
,quint64
);
void
conversation_builder_set_title(ConversationBuilder::Private*
,const ushort*, int
);
}
extern "C" {
void conversation_content_sort(ConversationContent::Private*, unsigned char column, Qt::SortOrder order = Qt::AscendingOrder);
...
QModelIndex ConversationContent::index(int row, int column, const QModelIndex &parent) const
{
    if (!parent.isValid() && row >= 0 && row < rowCount(parent) && column >= 0 && column < 1) {
        return createIndex(row, column, static_cast<quintptr>(row));
    }
...
Qt::ItemFlags ConversationContent::flags(const QModelIndex &i) const { auto flags = QAbstractItemModel::flags(i);
 return flags;
}
...
QVariant ConversationContent::headerData(int section, Qt::Orientation orientation, int role) const
{
    if (orientation != Qt::Horizontal) {
        return QVariant();
    }
...
bool ConversationContent::setHeaderData(int section, Qt::Orientation orientation, const QVariant &value, int role)
{
    if (orientation != Qt::Horizontal) {
        return false;
    }
...
extern "C" {ConversationContent::Private* conversation_content_new(ConversationContentPtrBundle*);
void conversation_content_free(ConversationContent::Private*);
void conversation_content_conversation_id_get(const ConversationContent::Private*, QByteArray*, qbytearray_set);
void conversation_content_conversation_id_set(ConversationContent::Private*, const char* bytes, int len);
void conversation_content_conversation_id_set_none(ConversationContent::Private*);
Members::Private* conversation_content_members_get(const ConversationContent::Private*);
Messages::Private* conversation_content_messages_get(const ConversationContent::Private*);
}
extern "C" {
...
Qt::ItemFlags Conversations::flags(const QModelIndex &i) const { auto flags = QAbstractItemModel::flags(i);
    if (i.column() == 0) {
...
extern "C" {Conversations::Private* conversations_new(ConversationsPtrBundle*);
...
void
conversations_clear_filter(Conversations::Private*
);
qint64
conversations_index_by_id(const Conversations::Private*
,const char*, int
);
bool
conversations_remove_conversation(Conversations::Private*
,quint64
);
bool
conversations_toggle_filter_regex(Conversations::Private*
);
}
extern "C" {
void document_attachments_data_document_attachment_name(const DocumentAttachments::Private*, int, QString*, qstring_set);
quint64 document_attachments_data_document_attachment_size(const DocumentAttachments::Private*, int);
void document_attachments_sort(DocumentAttachments::Private*, unsigned char column, Qt::SortOrder order = Qt::AscendingOrder);
...
QModelIndex DocumentAttachments::index(int row, int column, const QModelIndex &parent) const
{
    if (!parent.isValid() && row >= 0 && row < rowCount(parent) && column >= 0 && column < 1) {
        return createIndex(row, column, static_cast<quintptr>(row));
    }
...
Qt::ItemFlags DocumentAttachments::flags(const QModelIndex &i) const { auto flags = QAbstractItemModel::flags(i);
 return flags;
}
...
QVariant DocumentAttachments::headerData(int section, Qt::Orientation orientation, int role) const
{
    if (orientation != Qt::Horizontal) {
        return QVariant();
    }
...
bool DocumentAttachments::setHeaderData(int section, Qt::Orientation orientation, const QVariant &value, int role)
{
    if (orientation != Qt::Horizontal) {
        return false;
    }
...
extern "C" {DocumentAttachments::Private* document_attachments_new(DocumentAttachmentsPtrBundle*);
void document_attachments_free(DocumentAttachments::Private*);
}
extern "C" {Errors::Private* errors_new(ErrorsPtrBundle*);
void errors_free(Errors::Private*);
bool errors_try_poll_get(const Errors::Private*);
void
errors_next_error(Errors::Private*
, QString*, qstring_set
);
}
extern "C" {
void herald_sort(Herald::Private*, unsigned char column, Qt::SortOrder order = Qt::AscendingOrder);
...
QModelIndex Herald::index(int row, int column, const QModelIndex &parent) const
{
    if (!parent.isValid() && row >= 0 && row < rowCount(parent) && column >= 0 && column < 1) {
        return createIndex(row, column, static_cast<quintptr>(row));
    }
...
QModelIndex Herald::parent(const QModelIndex &) const
{
    return {};
}
...
Qt::ItemFlags Herald::flags(const QModelIndex &i) const { auto flags = QAbstractItemModel::flags(i);
 return flags;
}
...
QVariant Herald::headerData(int section, Qt::Orientation orientation, int role) const
{
    if (orientation != Qt::Horizontal) {
        return QVariant();
    }
...
bool Herald::setHeaderData(int section, Qt::Orientation orientation, const QVariant &value, int role)
{
    if (orientation != Qt::Horizontal) {
        return false;
    }
...
extern "C" {Herald::Private* herald_new(HeraldPtrBundle*);
...
ConversationBuilder::Private* herald_conversation_builder_get(const Herald::Private*);
...
bool
herald_login(Herald::Private*
);
void
herald_register_new_user(Herald::Private*
,const ushort*, int
,const ushort*, int
,const ushort*, int
);
void
herald_set_app_local_data_dir(Herald::Private*
,const ushort*, int
);
}
extern "C" {
void media_attachments_data_media_attachment_path(const MediaAttachments::Private*, int, QString*, qstring_set);
void media_attachments_sort(MediaAttachments::Private*, unsigned char column, Qt::SortOrder order = Qt::AscendingOrder);
...
QModelIndex MediaAttachments::index(int row, int column, const QModelIndex &parent) const
{
    if (!parent.isValid() && row >= 0 && row < rowCount(parent) && column >= 0 && column < 1) {
        return createIndex(row, column, static_cast<quintptr>(row));
    }
...
Qt::ItemFlags MediaAttachments::flags(const QModelIndex &i) const { auto flags = QAbstractItemModel::flags(i);
 return flags;
}
...
QVariant MediaAttachments::headerData(int section, Qt::Orientation orientation, int role) const
{
    if (orientation != Qt::Horizontal) {
        return QVariant();
    }
...
bool MediaAttachments::setHeaderData(int section, Qt::Orientation orientation, const QVariant &value, int role)
{
    if (orientation != Qt::Horizontal) {
        return false;
    }
...
extern "C" {MediaAttachments::Private* media_attachments_new(MediaAttachmentsPtrBundle*);
...
Qt::ItemFlags Members::flags(const QModelIndex &i) const { auto flags = QAbstractItemModel::flags(i);
 return flags;
}
...
extern "C" {Members::Private* members_new(MembersPtrBundle*);
...
bool
members_add_to_conversation(Members::Private*
,const ushort*, int
);
bool
members_remove_from_conversation_by_index(Members::Private*
,quint64
);
bool
members_toggle_filter_regex(Members::Private*
);
}
extern "C" {
...
Qt::ItemFlags MessageBuilder::flags(const QModelIndex &i) const { auto flags = QAbstractItemModel::flags(i);
 return flags;
}
...
extern "C" {MessageBuilder::Private* message_builder_new(MessageBuilderPtrBundle*);
...
DocumentAttachments::Private* message_builder_document_attachments_get(const MessageBuilder::Private*);
...
MediaAttachments::Private* message_builder_media_attachments_get(const MessageBuilder::Private*);
void message_builder_op_author_get(const MessageBuilder::Private*, QString*, qstring_set);
void message_builder_op_body_get(const MessageBuilder::Private*, QString*, qstring_set);
void message_builder_op_doc_attachments_get(const MessageBuilder::Private*, QString*, qstring_set);
option_qint64 message_builder_op_expiration_time_get(const MessageBuilder::Private*);
...
void message_builder_op_media_attachments_get(const MessageBuilder::Private*, QString*, qstring_set);
option_qint64 message_builder_op_time_get(const MessageBuilder::Private*);
bool
message_builder_add_attachment(MessageBuilder::Private*
,const ushort*, int
);
void
message_builder_clear_reply(MessageBuilder::Private*
);
void
message_builder_finalize(MessageBuilder::Private*
);
bool
message_builder_remove_doc(MessageBuilder::Private*
,quint64
);
bool
message_builder_remove_media(MessageBuilder::Private*
,quint64
);
}
extern "C" {
void message_search_data_after_first_match(const MessageSearch::Private*, int, QString*, qstring_set);
void message_search_data_author(const MessageSearch::Private*, int, QString*, qstring_set);
void message_search_data_before_first_match(const MessageSearch::Private*, int, QString*, qstring_set);
...
void message_search_data_first_match(const MessageSearch::Private*, int, QString*, qstring_set);
...
Qt::ItemFlags MessageSearch::flags(const QModelIndex &i) const { auto flags = QAbstractItemModel::flags(i);
 return flags;
}
...
extern "C" {MessageSearch::Private* message_search_new(MessageSearchPtrBundle*);
...
void
message_search_clear_search(MessageSearch::Private*
);
}
extern "C" {
...
void messages_data_doc_attachments(const Messages::Private*, int, QString*, qstring_set);
option_qint64 messages_data_expiration_time(const Messages::Private*, int);
void messages_data_full_body(const Messages::Private*, int, QString*, qstring_set);
...
void messages_data_media_attachments(const Messages::Private*, int, QString*, qstring_set);
void messages_data_msg_id(const Messages::Private*, int, QByteArray*, qbytearray_set);
void messages_data_op_author(const Messages::Private*, int, QString*, qstring_set);
void messages_data_op_body(const Messages::Private*, int, QString*, qstring_set);
option_quint32 messages_data_op_color(const Messages::Private*, int);
void messages_data_op_doc_attachments(const Messages::Private*, int, QString*, qstring_set);
...
void messages_data_op_media_attachments(const Messages::Private*, int, QString*, qstring_set);
void messages_data_op_msg_id(const Messages::Private*, int, QByteArray*, qbytearray_set);
void messages_data_op_name(const Messages::Private*, int, QString*, qstring_set);
...
option_quint32 messages_data_user_color(const Messages::Private*, int);
void messages_data_user_name(const Messages::Private*, int, QString*, qstring_set);
void messages_data_user_profile_picture(const Messages::Private*, int, QString*, qstring_set);
...
Qt::ItemFlags Messages::flags(const QModelIndex &i) const { auto flags = QAbstractItemModel::flags(i);
 return flags;
}
...
QVariant Messages::userColor(int row) const
{
    QVariant v;
    v = messages_data_user_color(m_d, row);
    return v;
}

QString Messages::userName(int row) const
{
    QString s;
    messages_data_user_name(m_d, row, &s, set_qstring);
    return s;
}

QString Messages::userProfilePicture(int row) const
{
    QString s;
    messages_data_user_profile_picture(m_d, row, &s, set_qstring);
    return s;
}
...
return userColor(index.row());
        case Qt::UserRole + 24:
return cleanNullQVariant(QVariant::fromValue(userName(index.row())));
        case Qt::UserRole + 25:
return cleanNullQVariant(QVariant::fromValue(userProfilePicture(index.row())));
} break;
    }
    return QVariant();
}
...
QHash<int, QByteArray> Messages::roleNames() const {
    ...
    names.insert(Qt::UserRole + 13, "opColor");
    names.insert(Qt::UserRole + 14, "opDocAttachments");
    names.insert(Qt::UserRole + 15, "opExpirationTime");
    names.insert(Qt::UserRole + 16, "opInsertionTime");
    names.insert(Qt::UserRole + 17, "opMediaAttachments");
    names.insert(Qt::UserRole + 18, "opMsgId");
    names.insert(Qt::UserRole + 19, "opName");
    names.insert(Qt::UserRole + 20, "receiptStatus");
    names.insert(Qt::UserRole + 21, "replyType");
    names.insert(Qt::UserRole + 22, "serverTime");
    names.insert(Qt::UserRole + 23, "userColor");
    names.insert(Qt::UserRole + 24, "userName");
    names.insert(Qt::UserRole + 25, "userProfilePicture");
return names;}
...
extern "C" {Messages::Private* messages_new(MessagesPtrBundle*);
...
bool
messages_clear_conversation_history(Messages::Private*
);
void
messages_clear_search(Messages::Private*
);
bool
messages_delete_message(Messages::Private*
,quint64
);
qint64
messages_index_by_id(const Messages::Private*
,const char*, int
);
qint64
messages_next_search_match(Messages::Private*
);
qint64
messages_prev_search_match(Messages::Private*
);
bool
messages_save_all_attachments(const Messages::Private*
,quint64
,const ushort*, int
);
void
messages_set_elision_char_count(Messages::Private*
,quint16
);
void
messages_set_elision_chars_per_line(Messages::Private*
,quint8
);
void
messages_set_elision_line_count(Messages::Private*
,quint8
);
void
messages_set_search_hint(Messages::Private*
,float
,float
);
}
extern "C" {ReplyWidthCalc::Private* reply_width_calc_new(ReplyWidthCalcPtrBundle*);
void reply_width_calc_free(ReplyWidthCalc::Private*);
double
reply_width_calc_doc(const ReplyWidthCalc::Private*
,double
,double
,double
,double
...
double
reply_width_calc_hybrid(const ReplyWidthCalc::Private*
,double
,double
,double
,double
...
double
reply_width_calc_image(const ReplyWidthCalc::Private*
,double
,double
,double
,double
...
double
reply_width_calc_text(const ReplyWidthCalc::Private*
,double
,double
,double
,double
...
double
reply_width_calc_unknown(const ReplyWidthCalc::Private*
,double
,double
,double
,double
...
Qt::ItemFlags Users::flags(const QModelIndex &i) const { auto flags = QAbstractItemModel::flags(i);
    if (i.column() == 0) {
        flags |= Qt::ItemIsEditable;
    }
 return flags;
...
extern "C" {Users::Private* users_new(UsersPtrBundle*);
...
void
users_add(Users::Private*
,const ushort*, int
, QByteArray*, qbytearray_set
);
void
users_clear_filter(Users::Private*
);
quint32
users_color_by_id(const Users::Private*
,const ushort*, int
);
void
users_name_by_id(const Users::Private*
,const ushort*, int
, QString*, qstring_set
);
void
users_profile_picture_by_id(const Users::Private*
,const ushort*, int
, QString*, qstring_set
);
bool
users_toggle_filter_regex(Users::Private*
);
}
extern "C" {
...
void users_search_data_name(const UsersSearch::Private*, int, QString*, qstring_set);
void users_search_data_profile_picture(const UsersSearch::Private*, int, QString*, qstring_set);
...
void users_search_data_user_id(const UsersSearch::Private*, int, QString*, qstring_set);
void users_search_sort(UsersSearch::Private*, unsigned char column, Qt::SortOrder order = Qt::AscendingOrder);
...
Qt::ItemFlags UsersSearch::flags(const QModelIndex &i) const { auto flags = QAbstractItemModel::flags(i);
    if (i.column() == 0) {
        flags |= Qt::ItemIsEditable;
    }
 return flags;
...
QVariant UsersSearch::headerData(int section, Qt::Orientation orientation, int role) const
{
    if (orientation != Qt::Horizontal) {
        return QVariant();
    }
...
bool UsersSearch::setData(const QModelIndex &index, const QVariant &value, int role)
{
    if (index.column() == 0) {
        if (role == Qt::UserRole + 4) {
            if (value.canConvert(qMetaTypeId<bool>())) {
...
extern "C" {UsersSearch::Private* users_search_new(UsersSearchPtrBundle*);
void users_search_free(UsersSearch::Private*);
void users_search_filter_get(const UsersSearch::Private*, QString*, qstring_set);
void users_search_filter_set(UsersSearch::Private*, const ushort *str, int len);
void users_search_filter_set_none(UsersSearch::Private*);
void
users_search_clear_filter(UsersSearch::Private*
);
void
users_search_refresh(UsersSearch::Private*
);
}
extern "C" {Utils::Private* utils_new(UtilsPtrBundle*);
void utils_free(Utils::Private*);
bool
utils_compare_byte_array(const Utils::Private*
,const char*, int
,const char*, int
);
void
utils_image_dimensions(const Utils::Private*
,const ushort*, int
, QString*, qstring_set
);
bool
utils_is_valid_rand_id(const Utils::Private*
,const char*, int
);
bool
utils_save_file(const Utils::Private*
,const ushort*, int
,const ushort*, int
);
}
...
Config::Config(QObject *parent):
    QObject(parent),
m_d(config_new( new ConfigPtrBundle { this,
configColorChanged,
...
ConversationBuilder::ConversationBuilder(bool /*owned*/, QObject *parent):
    QAbstractItemModel(parent),m_d(nullptr), m_ownsPrivate(false){initHeaderData();
}

ConversationBuilder::ConversationBuilder(QObject *parent):
    QAbstractItemModel(parent),
m_d(conversation_builder_new( new ConversationBuilderPtrBundle { this,
...
void ConversationBuilder::clear()
{
    return conversation_builder_clear(m_d);
}
...
m_d(nullptr), m_ownsPrivate(false){initHeaderData();
}
...
ConversationContent::ConversationContent(QObject *parent):
    ...
    m_messages(new Messages(false, this)),
m_d(conversation_content_new( new ConversationContentPtrBundle { this,
conversationContentConversationIdChanged, m_members,
...
, m_messages, m_messages->m_builder,
messageBuilderBodyChanged, m_messages->m_builder->m_documentAttachments       ,
...
messageBuilderIsReplyChanged, m_messages->m_builder->m_mediaAttachments       ,
    ...
    m_ownsPrivate(true)
{
    ...
    m_messages->m_builder->m_documentAttachments->m_d = message_builder_document_attachments_get(m_messages->m_builder->m_d);
    m_messages->m_builder->m_mediaAttachments->m_d = message_builder_media_attachments_get(m_messages->m_builder->m_d);
    connect(this->m_members, &Members::newDataReady, this->m_members, [this](const QModelIndex& i) {
        this->m_members->fetchMore(i);
    }, Qt::QueuedConnection);
    connect(this->m_messages->m_builder->m_documentAttachments, &DocumentAttachments::newDataReady, this->m_messages->m_builder->m_documentAttachments, [this](const QModelIndex& i) {
        this->m_messages->m_builder->m_documentAttachments->fetchMore(i);
    }, Qt::QueuedConnection);
    connect(this->m_messages->m_builder->m_mediaAttachments, &MediaAttachments::newDataReady, this->m_messages->m_builder->m_mediaAttachments, [this](const QModelIndex& i) {
        this->m_messages->m_builder->m_mediaAttachments->fetchMore(i);
    }, Qt::QueuedConnection);
    connect(this->m_messages->m_builder, &MessageBuilder::newDataReady, this->m_messages->m_builder, [this](const QModelIndex& i) {
        this->m_messages->m_builder->fetchMore(i);
    }, Qt::QueuedConnection);
    connect(this->m_messages, &Messages::newDataReady, this->m_messages, [this](const QModelIndex& i) {
        this->m_messages->fetchMore(i);
    }, Qt::QueuedConnection);
    connect(this, &ConversationContent::newDataReady, this, [this](const QModelIndex& i) {
        this->fetchMore(i);
    }, Qt::QueuedConnection);
initHeaderData();
}
...
const Members* ConversationContent::members() const
{
    return m_members;
}
Members* ConversationContent::members()
{
    return m_members;
}

const Messages* ConversationContent::messages() const
{
    return m_messages;
}
...
Conversations::Conversations(QObject *parent):
    QAbstractItemModel(parent),
m_d(conversations_new( new ConversationsPtrBundle { this,
...
{
    return conversations_index_by_id(m_d, conversation_id.data(), conversation_id.size());
}
...
DocumentAttachments::DocumentAttachments(QObject *parent):
    QAbstractItemModel(parent),
m_d(document_attachments_new( new DocumentAttachmentsPtrBundle { this       ,
        [](const DocumentAttachments* o) {
            Q_EMIT o->newDataReady(QModelIndex());
        },
        [](DocumentAttachments* o) {
    ...
    m_ownsPrivate(true)
{
    connect(this, &DocumentAttachments::newDataReady, this, [this](const QModelIndex& i) {
        this->fetchMore(i);
    }, Qt::QueuedConnection);
initHeaderData();
}
...
Errors::Errors(QObject *parent):
    QObject(parent),
m_d(errors_new( new ErrorsPtrBundle { this,
...
Herald::Herald(QObject *parent):
    QAbstractItemModel(parent),
    m_config(new Config(false, this)),
    m_conversationBuilder(new ConversationBuilder(false, this)),
    m_conversations(new Conversations(false, this)),
    m_errors(new Errors(false, this)),
    m_messageSearch(new MessageSearch(false, this)),
    ...
    m_usersSearch(new UsersSearch(false, this)),
    m_utils(new Utils(false, this)),
m_d(herald_new( new HeraldPtrBundle { this, m_config,
configColorChanged,
configColorschemeChanged,
configConfigIdChanged,
configNameChanged,
    ...
    m_ownsPrivate(true)
{
    ...
    connect(this->m_conversationBuilder, &ConversationBuilder::newDataReady, this->m_conversationBuilder, [this](const QModelIndex& i) {
        this->m_conversationBuilder->fetchMore(i);
    }, Qt::QueuedConnection);
    connect(this->m_conversations, &Conversations::newDataReady, this->m_conversations, [this](const QModelIndex& i) {
        this->m_conversations->fetchMore(i);
    }, Qt::QueuedConnection);
    connect(this->m_messageSearch, &MessageSearch::newDataReady, this->m_messageSearch, [this](const QModelIndex& i) {
        this->m_messageSearch->fetchMore(i);
    }, Qt::QueuedConnection);
    connect(this->m_users, &Users::newDataReady, this->m_users, [this](const QModelIndex& i) {
        this->m_users->fetchMore(i);
    }, Qt::QueuedConnection);
    connect(this->m_usersSearch, &UsersSearch::newDataReady, this->m_usersSearch, [this](const QModelIndex& i) {
        this->m_usersSearch->fetchMore(i);
    }, Qt::QueuedConnection);
    connect(this, &Herald::newDataReady, this, [this](const QModelIndex& i) {
        this->fetchMore(i);
    }, Qt::QueuedConnection);
initHeaderData();
}
...
const Config* Herald::config() const
{
    return m_config;
}
...
bool Herald::configInit() const
{
    return herald_config_init_get(m_d);
}
...
bool Herald::connectionUp() const
{
    return herald_connection_up_get(m_d);
}
...
const Conversations* Herald::conversations() const
{
    return m_conversations;
}
Conversations* Herald::conversations()
{
    return m_conversations;
}

const Errors* Herald::errors() const
{
    return m_errors;
}
Errors* Herald::errors()
{
    return m_errors;
}

const MessageSearch* Herald::messageSearch() const
{
    return m_messageSearch;
}
MessageSearch* Herald::messageSearch()
{
    return m_messageSearch;
}

const Users* Herald::users() const
{
    return m_users;
}
Users* Herald::users()
...
const UsersSearch* Herald::usersSearch() const
{
    return m_usersSearch;
}
UsersSearch* Herald::usersSearch()
{
    return m_usersSearch;
}

const Utils* Herald::utils() const
{
    return m_utils;
}
Utils* Herald::utils()
...
bool Herald::login()
{
    return herald_login(m_d);
}
void Herald::registerNewUser(const QString& user_id, const QString& addr, const QString& port)
{
    return herald_register_new_user(m_d, user_id.utf16(), user_id.size(), addr.utf16(), addr.size(), port.utf16(), port.size());
}
...
MediaAttachments::MediaAttachments(QObject *parent):
    QAbstractItemModel(parent),
m_d(media_attachments_new( new MediaAttachmentsPtrBundle { this       ,
        [](const MediaAttachments* o) {
            Q_EMIT o->newDataReady(QModelIndex());
        },
        [](MediaAttachments* o) {
    ...
    m_ownsPrivate(true)
{
    connect(this, &MediaAttachments::newDataReady, this, [this](const QModelIndex& i) {
        this->fetchMore(i);
    }, Qt::QueuedConnection);
initHeaderData();
}
...
Members::Members(QObject *parent):
    QAbstractItemModel(parent),
m_d(members_new( new MembersPtrBundle { this,
membersFilterChanged,
membersFilterRegexChanged       ,
        [](const Members* o) {
            Q_EMIT o->newDataReady(QModelIndex());
...
MessageBuilder::MessageBuilder(bool /*owned*/, QObject *parent):
    QAbstractItemModel(parent),    m_documentAttachments(new DocumentAttachments(false, this)),
...
MessageBuilder::MessageBuilder(QObject *parent):
    ...
    m_mediaAttachments(new MediaAttachments(false, this)),
m_d(message_builder_new( new MessageBuilderPtrBundle { this,
messageBuilderBodyChanged, m_documentAttachments       ,
        [](const DocumentAttachments* o) {
            Q_EMIT o->newDataReady(QModelIndex());
        },
        [](DocumentAttachments* o) {
...
messageBuilderHasDocAttachmentChanged,
messageBuilderHasMediaAttachmentChanged,
messageBuilderIsReplyChanged, m_mediaAttachments       ,
        [](const MediaAttachments* o) {
            Q_EMIT o->newDataReady(QModelIndex());
        },
        [](MediaAttachments* o) {
    ...
    m_ownsPrivate(true)
{
    ...
    connect(this->m_documentAttachments, &DocumentAttachments::newDataReady, this->m_documentAttachments, [this](const QModelIndex& i) {
        this->m_documentAttachments->fetchMore(i);
    }, Qt::QueuedConnection);
    connect(this->m_mediaAttachments, &MediaAttachments::newDataReady, this->m_mediaAttachments, [this](const QModelIndex& i) {
        this->m_mediaAttachments->fetchMore(i);
    }, Qt::QueuedConnection);
...
MessageSearch::MessageSearch(QObject *parent):
    QAbstractItemModel(parent),
m_d(message_search_new( new MessageSearchPtrBundle { this,
messageSearchRegexSearchChanged,
messageSearchSearchPatternChanged       ,
        [](const MessageSearch* o) {
            Q_EMIT o->newDataReady(QModelIndex());
...
Messages::Messages(QObject *parent):
    QAbstractItemModel(parent),
    m_builder(new MessageBuilder(false, this)),
m_d(messages_new( new MessagesPtrBundle { this, m_builder,
messageBuilderBodyChanged, m_builder->m_documentAttachments       ,
        [](const DocumentAttachments* o) {
            Q_EMIT o->newDataReady(QModelIndex());
        },
        [](DocumentAttachments* o) {
...
messageBuilderHasDocAttachmentChanged,
messageBuilderHasMediaAttachmentChanged,
messageBuilderIsReplyChanged, m_builder->m_mediaAttachments       ,
        [](const MediaAttachments* o) {
            Q_EMIT o->newDataReady(QModelIndex());
        },
        [](MediaAttachments* o) {
    ...
    m_ownsPrivate(true)
{
    ...
    m_builder->m_documentAttachments->m_d = message_builder_document_attachments_get(m_builder->m_d);
    m_builder->m_mediaAttachments->m_d = message_builder_media_attachments_get(m_builder->m_d);
    connect(this->m_builder->m_documentAttachments, &DocumentAttachments::newDataReady, this->m_builder->m_documentAttachments, [this](const QModelIndex& i) {
        this->m_builder->m_documentAttachments->fetchMore(i);
    }, Qt::QueuedConnection);
    connect(this->m_builder->m_mediaAttachments, &MediaAttachments::newDataReady, this->m_builder->m_mediaAttachments, [this](const QModelIndex& i) {
        this->m_builder->m_mediaAttachments->fetchMore(i);
    }, Qt::QueuedConnection);
    connect(this->m_builder, &MessageBuilder::newDataReady, this->m_builder, [this](const QModelIndex& i) {
        this->m_builder->fetchMore(i);
    }, Qt::QueuedConnection);
...
const MessageBuilder* Messages::builder() const
{
    return m_builder;
}
...
double ReplyWidthCalc::doc(double bubble_max_width, double message_label_width, double message_body_width, double stamp_width, double reply_label_width, double reply_body_width, double reply_ts_width, double reply_file_clip_width) const
{
    return reply_width_calc_doc(m_d, bubble_max_width, message_label_width, message_body_width, stamp_width, reply_label_width, reply_body_width, reply_ts_width, reply_file_clip_width);
}
double ReplyWidthCalc::hybrid(double bubble_max_width, double message_label_width, double message_body_width, double stamp_width, double reply_label_width, double reply_body_width, double reply_ts_width, double reply_file_clip_width) const
{
    return reply_width_calc_hybrid(m_d, bubble_max_width, message_label_width, message_body_width, stamp_width, reply_label_width, reply_body_width, reply_ts_width, reply_file_clip_width);
}
double ReplyWidthCalc::image(double bubble_max_width, double message_label_width, double message_body_width, double stamp_width, double reply_label_width, double reply_body_width, double reply_ts_width) const
{
    return reply_width_calc_image(m_d, bubble_max_width, message_label_width, message_body_width, stamp_width, reply_label_width, reply_body_width, reply_ts_width);
}
double ReplyWidthCalc::text(double bubble_max_width, double message_label_width, double message_body_width, double stamp_width, double reply_label_width, double reply_body_width, double reply_ts_width) const
{
    return reply_width_calc_text(m_d, bubble_max_width, message_label_width, message_body_width, stamp_width, reply_label_width, reply_body_width, reply_ts_width);
}
double ReplyWidthCalc::unknown(double bubble_max_width, double message_label_width, double message_body_width, double unknown_body_width) const
{
    return reply_width_calc_unknown(m_d, bubble_max_width, message_label_width, message_body_width, unknown_body_width);
}
...
Users::Users(QObject *parent):
    QAbstractItemModel(parent),
m_d(users_new( new UsersPtrBundle { this,
usersFilterChanged,
usersFilterRegexChanged       ,
        [](const Users* o) {
            Q_EMIT o->newDataReady(QModelIndex());
...
UsersSearch::UsersSearch(QObject *parent):
    QAbstractItemModel(parent),
m_d(users_search_new( new UsersSearchPtrBundle { this,
usersSearchFilterChanged       ,
        [](const UsersSearch* o) {
            Q_EMIT o->newDataReady(QModelIndex());
        },
    ...
    m_ownsPrivate(true)
{
    connect(this, &UsersSearch::newDataReady, this, [this](const QModelIndex& i) {
        this->fetchMore(i);
    }, Qt::QueuedConnection);
initHeaderData();
}
...
users_search_filter_set(m_d, reinterpret_cast<const ushort*>(v.data()), v.size());
}
}
void UsersSearch::clearFilter()
{
    return users_search_clear_filter(m_d);
}
void UsersSearch::refresh()
{
    return users_search_refresh(m_d);
}
...
Utils::Utils(QObject *parent):
    QObject(parent),
m_d(utils_new( new UtilsPtrBundle { this})),
    m_ownsPrivate(true)
{
}
...
bool Utils::compareByteArray(const QByteArray& bs1, const QByteArray& bs2) const
{
    return utils_compare_byte_array(m_d, bs1.data(), bs1.size(), bs2.data(), bs2.size());
}
...
{
    return utils_save_file(m_d, fpath.utf16(), fpath.size(), target_path.utf16(), target_path.size());
}
