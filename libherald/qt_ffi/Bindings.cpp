...
bool Messages::errorSending(int row) const
{
    return messages_data_error_sending(m_d, row);
}

qint64 Messages::messageId(int row) const
{
...
bool Messages::reachedRecipient(int row) const
{
    return messages_data_reached_recipient(m_d, row);
}

bool Messages::reachedServer(int row) const
{
...
QVariant Messages::data(const QModelIndex &index, int role) const
{
    ...
    case 0:
        ...
        case Qt::UserRole + 3:
            return QVariant::fromValue(errorSending(index.row()));
        case Qt::UserRole + 4:
            return QVariant::fromValue(messageId(index.row()));
        case Qt::UserRole + 5:
            return op(index.row());
        case Qt::UserRole + 6:
            return QVariant::fromValue(reachedRecipient(index.row()));
        case Qt::UserRole + 7:
            return QVariant::fromValue(reachedServer(index.row()));
        case Qt::UserRole + 8:
...
QHash<int, QByteArray> Messages::roleNames() const {
    ...
    names.insert(Qt::UserRole + 3, "errorSending");
    names.insert(Qt::UserRole + 4, "messageId");
    names.insert(Qt::UserRole + 5, "op");
    names.insert(Qt::UserRole + 6, "reachedRecipient");
    names.insert(Qt::UserRole + 7, "reachedServer");
...
bool Messages::deleteConversationById(const QString& conversation_id)
{
